# IOCFormer-D:RGB-D Indiscernible Object Counting in Underwater Scenes
...
# Prepare data
## Download datasets
Please make sure you already downloaded IOCfish5k dataset. IOCfish5k contains the images and annotations.

Download IOCfish5K-D from [here](https://drive.google.com/file/d/1JobO82ASLSnyF3bqjiQumiT2D0OXmO1f/view?usp=sharing), which only contains the depth maps. Once you unzip the file, you will see two folders: depthmaps (contains gray depth maps), and depthmaps-color (contains colorful depth maps for visualization). Please copy the depthmaps folder to IOCfish5k dataset.
...
```
python -m torch.distributed.launch --nproc_per_node=1 --master_port 8219   test.py --dataset cod --pre weights/model_best.pth \
...
| IOCfish5K-D (val set) | MAE | MSE |
| :-------------------- | :-------- | :----- |
| Original paper                   | 15.19   | 32.89     |
