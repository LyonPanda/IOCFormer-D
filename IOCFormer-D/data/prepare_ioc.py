...
os.makedirs(train.replace('images', 'depthmaps'), exist_ok=True); os.makedirs(val.replace('images', 'depthmaps'), exist_ok=True); os.makedirs(test.replace('images', 'depthmaps'), exist_ok=True)
...
for ii in range(len(path_sets)):
    ...
    for im in all_list[ii]:
        ...
        depth_path=img_path.replace('images', 'depthmaps')
        print(img_path)
        print(depth_path)
        shutil.copyfile(img_path, os.path.join(path, im))
        shutil.copyfile(depth_path, os.path.join(path.replace('images_2048', 'depthmaps_2048'), im))
